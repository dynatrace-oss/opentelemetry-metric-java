        ...
        new ArrayList<DoubleSummaryPointData>() {
          {
            add(
                DoubleSummaryPointData.create(
                    ...
                    7,
                    700.70d,
                    Arrays.asList(ValueAtPercentile.create(0.0, 0.1), ValueAtPercentile.create(100.0, 100.1))));
            add(
                DoubleSummaryPointData.create(
                    1619687639000000000L,
                    1619687659000000000L,
                    ...
                    660.66d,
                    Arrays.asList(
                        ValueAtPercentile.create(0.0, 0.22), ValueAtPercentile.create(100.0, 123.45))));
            // Will be dropped since no min and max are set and are, by default, assumed to be NaN.
              //todo uncomment once the 0.1.2 version of the lib is released.
//            add(
//                    DoubleSummaryPointData.create(
//                            1619687639000000000L,
//                            1619687659000000000L,
...
//                            Collections.emptyList()));
    ...
    assertThat(doubleSummaryLines.get(0)).isEqualTo("doubleSummary gauge,min=0.1,max=100.1,sum=700.7,count=7 1619687659000");
    assertThat(doubleSummaryLines.get(1)).isEqualTo("doubleSummary gauge,min=0.22,max=123.45,sum=660.66,count=3 1619687659000");
  }
}
