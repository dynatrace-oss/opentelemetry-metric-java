...
public final class MetricAdapter {
    ...
    /**
     * This function first transforms the given labels to dimensions using {@link #convertLabelsToDimensions(Labels)}
     * and then adds static labels that are stored in the singleton instance, if there are any.
     *
